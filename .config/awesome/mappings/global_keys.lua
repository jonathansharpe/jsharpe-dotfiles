...
return gears.table.join(
  ...
  awful.key(
    ...
    "#40",
    function()
      awful.spawn("rofi -show drun -theme ~/.config/rofi/launchers/colorful/style_7.rasi")
    end,
  ...
  awful.key(
    ...
    "#23",
    function()
      awful.spawn("rofi -show window -theme ~/.config/rofi/launchers/colorful/style_7.rasi")
    end,
