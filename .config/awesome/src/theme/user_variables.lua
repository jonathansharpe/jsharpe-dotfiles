...
user_vars = {
  ...
  autostart = {
	...
	"/home/jonathan/bin/rclone-start.sh"
  },
  ...
  font = {
    regular = "Fantasque Sans Mono Nerd Font Mono, 14",
    bold = "Fantasque Sans Mono Nerd Font Mono, bold 14",
    extrabold = "Fantasque Sans Mono Nerd Font Mono, ExtraBold 14",
    specify = "Fantasque Sans Mono Nerd Font Mono"
  },
  ...
  wallpaper = home .. "/Pictures/nord_scenary.png",
